...
1. **Jobs**: MyStats will kick off a job in the background to sync your data. This job will execute in the background every 60 minutes.
...
Now you may be wondering how MyStats how to account for duplicate tracks. We completely wipe all data on upload and re-calculate everything from the listening history. This means no tracks or calculations will overlap.
